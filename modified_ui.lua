...
function Library:CreateWindow(info)
	...
	local MinWidth, MinHeight = 250, 200
	...
	ResizeHandle.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
			...
			startSize = Background_1.AbsoluteSize
		end
	end)
	...
	game:GetService("UserInputService").InputChanged:Connect(function(input)
		if resizing and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
			...
			Background_1.Size = UDim2.new(0, newW, 0, newH)
		end
	end)

	ResizeHandle.MouseEnter:Connect(function()
		Tw({v = ResizeHandle, t = 0.15, s = "Linear", d = "Out", g = {BackgroundTransparency = 0.85}}):Play()
	end)
	ResizeHandle.MouseLeave:Connect(function()
		Tw({v = ResizeHandle, t = 0.15, s = "Linear", d = "Out", g = {BackgroundTransparency = 1}}):Play()
	end)
